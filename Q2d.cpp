...
int main() {
    ...
    for (int cs = 0; cs < 3; cs++) {
        int chunk_size = chunk_sizes[cs];  // Fetch the current chunk size
        ...
        std::cout << "Dynamic scheduling, Chunk Size: " << chunk_size << ", Elapsed Time: " << end_time - start_time << " seconds." << std::endl;
    }
